...
This lets us avoid the problem of reference bias, which can be understood as the a limitation of analyses to genome sequences that are similar to a chosen reference genome.
...
Here, we present \textit{seqwish}, an algorithm for the generation of a pangenome graph from of pairwise alignments.
...
We regard this as outside of the scope of the presented work, which focuses on a key kernel which is a bottleneck in the pangenome graph construction process.
