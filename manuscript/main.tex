...
Our algorithm flows through three complementary graph models.
(\textit{1}) We transform the alignments and input sequences into an \textit{alignment graph} \citep{Kehr_2014}.
(\textit{2}) We then transitively close match relations in this graph to produce single nodes of a \textit{sequence graph} \citep{Hein_1989}.
