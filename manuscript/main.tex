...
As we observe in Figure \ref{fig:yeast}, \textit{minigraph} indeed generates a distribution of graph lengths with clusters that apparently correspond to similar regions of the permutation space.
...
%, when considering the variance of the length, node count, and edge count of the graphs
