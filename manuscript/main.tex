...
Existing related approaches depend on a single reference, a specific ordering of genomes, and do not provide base-level information about the mapping of genomes into the pangenome.
...
These methods limit computational costs by reducing the number of pairwise comparisons, but in turn their results depend on input genome order, selected reference, or guide-tree topology.
