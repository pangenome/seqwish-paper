...
We infer that two sequences match when they both ``step'' on the same node or series of nodes.
This follows from our definition of the graph itself.
...
%The core of our graph constr TODO HERE
...
As input, we have $Q = g_1 \ldots g_N$, which is a concatenation of the $N$ genome sequences from which we will build the graph.
