...
Existing related approaches depend on a single reference, a specific ordering of genomes, a de Bruijn model, and may not describe the base-level mapping of genomes into the pangenome.
