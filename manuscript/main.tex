...
\begin{document}
    ...
    \title[seqwish: inducing pangenome graphs]{seqwish: inducing pangenome graphs}
    ...
    \abstract{
        ...
        One of its most common forms is the variation graph model.
        ...
        \textbf{Results:}
        We wrote seqwish, a novel tool to induce a variation graph from a set of sequences and alignments between them.
        seqwish operates in external memory, by conversion of the alignment set into an alignment graph and the subsequent
