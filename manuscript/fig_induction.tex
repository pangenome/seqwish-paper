...
\begin{tikzpicture}[auto,
    ...
    squarednode/.style={rectangle, draw=white!60, fill=black!100, text=white, very thick, minimum size=5mm},
    graphnode/.style={rectangle, draw=white!60, fill=white!100, text=black, very thick, minimum size=5mm},
...
%Nodes
\node[squarednode,label={[text=white]left:seq1}] (seqA1) {G};
...
\node[squarednode,label={[text=white]left:seq2}] (seqB1) [below of=seqA1] {G};
...
\node[squarednode,label={[text=white]left:seq3}] (seqC1) [below of=seqB1] {G};
...
\node[graphnode,label={[text=white]left:graph},draw=gray!20] (g1) [below = 1.25cm of seqC1] {1};
