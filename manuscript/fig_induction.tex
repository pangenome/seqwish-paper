...
%Lines
\draw[very thick,color=red] (seqA1) -- (seqA2);
\draw[very thick,color=red] (seqA2) -- (seqA3);
\draw[very thick,color=red] (seqA3) -- (seqA4);
\draw[very thick,color=red] (seqA4) -- (seqA5);
\draw[very thick,color=red] (seqA5) -- (seqA6);
\draw[very thick,color=red] (seqA6) -- (seqA7);

\draw[very thick,color=green] (seqB1) -- (seqB2);
\draw[very thick,color=green] (seqB2) -- (seqB3);
\draw[very thick,color=green] (seqB3) -- (seqB4);
\draw[very thick,color=green] (seqB4) -- (seqB5);
\draw[very thick,color=green] (seqB5) -- (seqB6);
\draw[very thick,color=green] (seqB6) -- (seqB7);

\draw[very thick,color=blue] (seqC1) -- (seqC2);
\draw[very thick,color=blue] (seqC2) -- (seqC3);
\draw[very thick,color=blue] (seqC3) -- (seqC4);
\draw[very thick,color=blue] (seqC4) -- (seqC5);
